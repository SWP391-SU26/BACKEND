...
public class SemesterDto {
 ...
 public static class Response { public UUID semesterWorkspaceId; public String semesterCode; public String semesterName; public LocalDate startDate; public LocalDate endDate; public String status; public LocalDateTime createdAt; public LocalDateTime deletedAt; public static Response from(SemesterWorkspace e){ Response r=new Response(); r.semesterWorkspaceId=e.getSemesterWorkspaceId();r.semesterCode=e.getSemesterCode();r.semesterName=e.getSemesterName();r.startDate=e.getStartDate();r.endDate=e.getEndDate();r.status=e.getStatus();r.createdAt=e.getCreatedAt();r.deletedAt=e.getDeletedAt();return r;} }
